 ...
 *   file: { create, findByToken, findById, findByIds, listByTodo, listByTodoIds, listForAdmin, allTokens, stats, removeByIds }  // 统一文件元数据（source=todo 任务附件 / user 各模块 md 文件；本体在 env.FILES）
