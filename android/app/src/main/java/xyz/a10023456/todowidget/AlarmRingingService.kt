...
class AlarmRingingService : Service() {
    ...
    private fun buildNotification(alarm: StoredTaskAlarm): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(R.drawable.ic_notification, "停止", commandPendingIntent(ACTION_STOP, 1))
            .addAction(R.drawable.ic_notification, "再等一会", commandPendingIntent(ACTION_SNOOZE, 2))
